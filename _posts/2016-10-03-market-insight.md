...
Here's a taste of the census data. There is some trend of a neighborhood that has a larger amount of millennials has a larger median income. The fraction of women in neighborhoods is consistently higher than the fraction of men as can be seen from the larger density of red points greater than 0.5 (matching the common understanding!)
